...
public class DialogHelper {
	...
	public static XPropertySet getRadioButtonInfo(XDialog dialog, String componentId) {
		XControlContainer xDlgContainer = (XControlContainer) UnoRuntime.queryInterface(XControlContainer.class,
				dialog);
		XControl control = xDlgContainer.getControl(componentId);
		XControlModel xControlModel = control.getModel();
		return (XPropertySet) UnoRuntime.queryInterface(XPropertySet.class, xControlModel);
	}
